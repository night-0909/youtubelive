...
def microseconds_to_timestamp(microseconds, format='%Y-%m-%d %H:%M:%S', tz="UTC"):
    ...
    date = datetime.datetime.fromtimestamp(microseconds // 1000000)
    tzinfo = ZoneInfo(tz)
    value = date.astimezone(tzinfo)
